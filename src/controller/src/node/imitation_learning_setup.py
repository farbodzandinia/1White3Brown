...
class DataCollector:
    ...
    def __init__(self, save_directory):
        ...
        rospy.loginfo("DataCollector initialized.")
    ...
    def shutdown_hook(self):
        self.csv_file.close()
        rospy.loginfo("DataCollector shutdown, saved {} images.".format(self.img_count))

if __name__ == "__main__":
    
    save_dir = rospy.get_param('~save_dir', 'data')
    ...
    try:
        ...
        rospy.loginfo("Shutting down DataCollector node.")
